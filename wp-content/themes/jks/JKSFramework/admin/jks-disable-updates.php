...
if (($jks_disable['jks_disable_updates'] == "") or ($jks_disable['jks_disable_updates'] == "on")) {

    class JKS_Disable_WordPress_Updates
    {
        ...
        function jks_Disable_WordPress_Updates()
        {
            $this->__construct();
        }
    ...
    if (class_exists('JKS_Disable_WordPress_Updates')) {
        $JKS_Disable_WordPress_Updates = new JKS_Disable_WordPress_Updates();
    }
